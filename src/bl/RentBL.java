...
public class RentBL {
    ...
    public String countSumNewRentNotifications(String JsonObject){
        ...
        try {
            ...
            if (customerId != 0){
                notificationsCount = rentManager.getCustomerSumRentNotificationsCount(customerId);
            }
        } catch (Exception e) {
            e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
        }
...
//    }
     ...
     * @return
     */
    @Path("/getBuyerFeedback")
    @POST
    @Produces(MediaType.APPLICATION_JSON)
    public List<FeedbackBuyerBean> getBuyerFeedback(String JsonObject){
        JSONObject json = null;
        ...
        try {
            ...
            int pageNum = Integer.parseInt(json.get("SectionNum").toString()); 
            int resultsAmount = Integer.parseInt(json.get("SectionSize").toString()); 
            ...
            try{
                ...
                lstFeedback = rentManager.getBuyerFeedback(wantedCustomerId, pageNum, resultsAmount);
            } catch(Exception e){
            }
            
            if (wantedCustomerId == ApplicationConstants.DEFAULT_CUSTOMER_ID){
                lstFeedback = rentManager.getBuyerFeedback(customerId, pageNum, resultsAmount);
            }
     ...
     * @return
     */
    @Path("/getSupplierFeedback")
    @POST
    @Produces(MediaType.APPLICATION_JSON)
    public List<FeedbackSupplierBean> getSupplierFeedback(String JsonObject){
        JSONObject json = null;
        ...
        try {
            ...
            try{
                ...
                lstFeedback = rentManager.getSupplierFeedback(wantedCustomerId, pageNum, resultsAmount);
            } catch(Exception e){
            }
            
            if (wantedCustomerId == ApplicationConstants.DEFAULT_CUSTOMER_ID){
                lstFeedback = rentManager.getSupplierFeedback(customerId, pageNum, resultsAmount);
            }
     ...
     * @return
     */
    @Path("/getItemFeedback")
    @POST
    @Produces(MediaType.APPLICATION_JSON)
    public List<FeedbackItemBean> getItemFeedback(String JsonObject){
        JSONObject json = null;
        ...
        try {
            ...
            lstFeedback = rentManager.getItemFeedback(itemId, pageNum, resultsAmount);
