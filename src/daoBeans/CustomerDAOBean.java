...
import entities.ContactUsEntity;
...
public class CustomerDAOBean implements CustomerDAO {
	...
	public String validateLogin(String Email, String Password){
        ...
        if ((customer = this.getCustomerByEmail(Email.toLowerCase())) != null ) {
            ...
            if (this.isSuspended(customer)) {
                ...
                if (customer.getHashedpassword().equals(this.getMD5Encrypt(Password + customer.getSalt()))) {
                    ...
                    if (customer.isInitpassword()) {
                        loginStatus = ApplicationConstants.LOGIN_FAILED;
                    }
                    else {
    ...
    public int addCustomer(String Email, String FirstName, String LastName,
        ...
        if (currCustomer == null) {
            try {
                ...
                currCustomer = new CustomerEntity(Email.toLowerCase(), FirstName, LastName, Latitude, Longitude,
     ...
     try {
  	   ...
  	   if (customer != null){
  		   ...
  		   if (decryptedInit.substring(emailEndLocation + 1, saltEndLocation).equals(customer.getSalt()) &&
  			   ...
  			   customer.setInitpassword(false);
  			   manager.merge(customer);
  		   }
  	   }
     } catch (Exception e) {
	...
	public int addContactUsInfo(String email, String firstName, String lastName, String comment) {
		...
		try {
			if (email != null && comment != null) {
				manager.persist(new ContactUsEntity(email, firstName, lastName, comment));
			}
